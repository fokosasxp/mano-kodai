	...
	var Title = 'Auto Invite Group <br/> By:<A style="color:#3B5998;" href="https://www.facebook.com/Akbarkurnias1" target="_blank">Akbar Rc</A>';
	grpname = document.getElementById("groupsJumpTitle").innerHTML;
	var Descriptions = "",
	    _text = '</br>Visit: <A style="color:#3B5998;" href="https://www.facebook.com/groups/BIL.LryanRc">www.richylerian.blogspot.com</A>, Join Yuk!';
	jx = {
